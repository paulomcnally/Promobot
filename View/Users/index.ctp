<div class="users index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $user['User']['id']), null, __('Seguro que desea borrar # %s?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nuevo Ususario'), array('action' => 'add')); ?></li>
