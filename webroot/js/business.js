...
function addBusinessImage(){
	...
	//newImage += '<input type="file" id="image-'+imageCounter+'" label="Imagen" name="data[Image]['+imageCounter+'][name]">';
        newImage += '<input type="file" id="image-'+imageCounter+'" label="Imagen" name="data[Image]['+imageCounter+']">';
