...
<?php echo $this->Form->create('Taxi', array('type' => 'file')); ?>
	<fieldset>
		<legend><?php echo __('Editar Taxi'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $this->Form->value('Taxi.id')), null, __('Seguro que desea borrar # %s?', $this->Form->value('Taxi.id'))); ?></li>
